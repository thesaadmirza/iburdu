...
@section('title'){{$user->name}}All articles - @parent @stop
    ...
    <div class="panel-body remove-pd-h">
        @if(count($articles))
            @if($currentUser && $currentUser->id == $user->id)
                ...
                You can click "Comment" to modify the article to allow comments.
                </div>
            @endif
            <ul class="list-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p class="text-danger text-center">Confirm delete article《<strong class="title"></strong>》？</p>
                        </div>
