                ...
                @else
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="/user/{{auth()->id()}}/notifications"><i class="fa fa-bell-o fa-fw"></i> Notice <span class="badge @if(App\User::noticeCount())grow bg-danger @endif">{{ App\User::noticeCount() }}</span></a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="/user/{{auth()->id()}}/edit"><i class="fa fa-edit fa-fw"></i> edit information</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="/user/{{auth()->id()}}/resetpwd"><i class="fa fa-gear fa-fw"></i> change Password</a>
                            </li>
                            <li class="divider"></li>
                            <li>
