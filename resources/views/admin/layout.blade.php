            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="/user/{{auth()->id()}}/resetpwd"><i class="fa fa-gear fa-fw"></i> Reset Password</a>
                        </li>
                        <li class="divider"></li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/admin/articles/index">Articles LIst</a>
                                </li>
                                <li>
                                    <a href="/admin/articles/trash">Trash</a>
                                </li>
                                <li>
                                    <a href="/admin/articles/tags">Tags</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/admin/images/index">Images list</a>
                                </li>
                            </ul>
                        </li>
                        @endcan
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/admin/users/index">user list</a>
                                </li>
                                <li>
                                    <a href="/admin/users/roles">user group</a>
                                </li>
                            </ul>
                        </li>
                        @endcan
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/admin/options/index">System settings</a>
                                </li>
                                {{-- <li>
                                    <a href="/admin/options/create">Add system variables</a>
                                </li> --}}
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/admin/notifications/index">system information</a>
                                </li>
                                <li>
                                    <a href="/admin/notifications/create">make an announcement</a>
                                </li>
                            </ul>
                        </li>
                        @endcan
